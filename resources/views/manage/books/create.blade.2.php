      ...
      <div class="columns">
        <div class="column is-three-quarters-desktop is-three-quarters-tablet">
          <div class="field">
            ...
            <p class="control">
              <input type="text" placeholder="Book Title" class="input" name="title" id="title">
            </p>
          </div>
          ...
          <div class="m-t-20">
            ...
            <p class="control">
              <input type="textarea" placeholder="Compose your masterpiece..." class="input" name="content" id="content">
            </p>
          </div>
